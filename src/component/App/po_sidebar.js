...
const sidebarImages = importAllImages(
  require.context(
  ...
  <div className="sidebar">
    ...
    <div className="sidebar_navs">
      <ul style={{ marginTop: "10px" }}>
        <span className="archive_nav_head sidebar_hide">PURCHASE ORDER</span>
        {poNav.map((item, index) => (
          <li key={index}>
